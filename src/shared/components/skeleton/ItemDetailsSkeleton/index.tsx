    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="bg-background-surface border border-border rounded-lg p-6 lg:flex block gap-6">
        ...
        <div className="space-y-4 flex-1">
          ...
          {/* Quantity */}
          <div>
            <div className="h-5 w-16 bg-background-accent rounded mb-1" />
            <div className="h-5 w-10 bg-background-accent rounded" />
          </div>

          {/* Description */}
          <div>
            <div className="h-5 w-28 bg-background-accent rounded mb-1" />
          ...
          <div>
            <div className="h-5 w-28 bg-background-accent rounded mb-1" />
            <div className="h-5 w-24 bg-background-accent rounded" />
          </div>
        </div>
      </div>
    </div>
