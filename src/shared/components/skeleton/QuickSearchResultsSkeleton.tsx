      ...
      <div>
        ...
        <div className="space-y-1">
          {[...Array(2)].map((_, i) => (
            <div
              key={i}
              className="w-full flex items-center gap-3 px-3 py-3 rounded-lg bg-background-surface/50"
            >
              {/* Icon */}
              ...
              <div className="flex-1 min-w-0 space-y-1">
                {/* Name */}
                <div className="h-4 w-3/4 bg-background-accent rounded" />
                {/* Location */}
                <div className="h-3 w-1/2 bg-background-accent rounded" />
              </div>
            </div>
          ))}
        </div>
