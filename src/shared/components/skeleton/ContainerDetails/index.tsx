    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="bg-background-surface dark:bg-background-dark-surface border border-border dark:border-border-dark rounded-lg p-6 lg:flex block gap-6">
        ...
        <div className="space-y-4 flex-1">
          ...
          {/* Description */}
          <div>
            <div className="h-5 w-32 bg-background-accent dark:bg-background-accent/10 rounded mb-1" />
          ...
          <div>
            <div className="h-5 w-32 bg-background-accent dark:bg-background-accent/10 rounded mb-1" />
            <div className="h-5 w-28 bg-background-accent dark:bg-background-accent/10 rounded" />
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-border dark:border-border-dark pt-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="h-6 w-20 bg-background-accent dark:bg-background-accent/10 rounded" />
        </div>
          ...
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
              {[...Array(4)].map((_, i) => (
                ...
                >
                  {/* Image */}
                  <div className="aspect-square bg-background-accent dark:bg-background-accent/10" />
